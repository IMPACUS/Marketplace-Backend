...
public class QAlarmRestock extends EntityPathBase<AlarmRestock> {
    ...
    public final EnumPath<com.impacus.maketplace.entity.alarm.user.enums.RestockEnum> category = createEnum("category", com.impacus.maketplace.entity.alarm.user.enums.RestockEnum.class);
