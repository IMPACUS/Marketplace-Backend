...
public class QAlarmShoppingBenefits extends EntityPathBase<AlarmShoppingBenefits> {
    ...
    public final EnumPath<com.impacus.maketplace.entity.alarm.user.enums.ShoppingBenefitsEnum> category = createEnum("category", com.impacus.maketplace.entity.alarm.user.enums.ShoppingBenefitsEnum.class);
    ...
    public final EnumPath<com.impacus.maketplace.entity.alarm.user.enums.ShoppingBenefitsSubEnum> subcategory = createEnum("subcategory", com.impacus.maketplace.entity.alarm.user.enums.ShoppingBenefitsSubEnum.class);
