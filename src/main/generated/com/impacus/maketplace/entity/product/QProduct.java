...
public class QProduct extends EntityPathBase<Product> {
    ...
    public final DateTimePath<java.time.LocalDateTime> bundleDeliveryOptionAppliedAt = createDateTime("bundleDeliveryOptionAppliedAt", java.time.LocalDateTime.class);
