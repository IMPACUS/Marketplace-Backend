...
public class BrandCouponOverviewDTO {
    ...
    @QueryProjection
    public BrandCouponOverviewDTO(Long couponId, String name, String description, BenefitType benefitType, Long benefitValue, PeriodType periodType, LocalDate periodStartAt, LocalDate periodEndAt, TargetProductType productType, CoverageType useCoverageType, String useCoverageSubCategoryName) {
