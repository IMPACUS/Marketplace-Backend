...
import com.impacus.maketplace.repository.common.querydsl.BaseInfoCustomRepository;
...
@Repository
public interface BaseInfoRepository extends JpaRepository<BaseInfo, Long>, BaseInfoCustomRepository {
