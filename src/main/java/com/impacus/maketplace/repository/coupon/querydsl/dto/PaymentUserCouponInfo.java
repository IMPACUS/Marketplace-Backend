...
public class PaymentUserCouponInfo {
    ...
    @QueryProjection
    public PaymentUserCouponInfo(Long userCouponId, BenefitType benefitType, Long benefitValue, TargetProductType productType, CoverageType useCoverageType, String useCoverageSubCategoryName, StandardType useStandardType, Long useStandardValue) {
