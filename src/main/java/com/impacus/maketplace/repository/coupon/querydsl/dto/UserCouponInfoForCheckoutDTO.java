...
public class UserCouponInfoForCheckoutDTO {
    ...
    @QueryProjection
    public UserCouponInfoForCheckoutDTO(Long userCouponId, String couponName, BenefitType benefitType, Long benefitValue, CouponProductType productType, CoverageType useCoverageType, String useCoverageSubCategoryName, StandardType useStandardType, Long useStandardValue) {
