...
public class UserCouponInfoForCheckoutDTO {
    ...
    @QueryProjection
    public UserCouponInfoForCheckoutDTO(Long userCouponId, String couponName, BenefitType benefitType, Long benefitValue, ProductType productType, CoverageType useCoverageType, String useCoverageSubCategoryName, StandardType useStandardType, Long useStandardValue) {
