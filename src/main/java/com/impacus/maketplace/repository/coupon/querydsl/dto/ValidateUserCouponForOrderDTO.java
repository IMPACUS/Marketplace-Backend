...
public class ValidateUserCouponForOrderDTO {
    ...
    @QueryProjection
    public ValidateUserCouponForOrderDTO(Long userCouponId, BenefitType benefitType, Long benefitValue, CouponProductType productType, CoverageType useCoverageType, StandardType useStandardType, Long useStandardValue) {
