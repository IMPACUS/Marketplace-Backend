...
public class ValidateUserCouponForProductDTO {
    ...
    @QueryProjection
    public ValidateUserCouponForProductDTO(Long userCouponId, ProductType productType, CoverageType useCoverageType, String useCoverageSubCategoryName, StandardType useStandardType, Long useStandardValue) {
