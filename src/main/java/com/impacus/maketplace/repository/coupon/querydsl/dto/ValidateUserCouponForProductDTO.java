...
public class ValidateUserCouponForProductDTO {
    ...
    @QueryProjection
    public ValidateUserCouponForProductDTO(Long userCouponId, BenefitType benefitType, Long benefitValue, ProductType productType, CoverageType useCoverageType, String useCoverageSubCategoryName, StandardType useStandardType, Long useStandardValue) {
