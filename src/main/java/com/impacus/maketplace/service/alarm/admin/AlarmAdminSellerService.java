...
@Transactional
public class AlarmAdminSellerService {
    private final AlarmAdminForSellerRepository alarmAdminForSellerRepository;

    public void inputValidation(AlarmSellerCategoryEnum category, Set<AlarmSellerSubcategoryEnum> subcategorySet) {
    ...
    public void add(AddAlarmSellerDto addAlarmDto, AlarmSellerSubcategoryEnum subcategoryEnum) {
        alarmAdminForSellerRepository.save(addAlarmDto.toEntity(subcategoryEnum));
    }

    @Transactional(readOnly = true)
    public Optional<AlarmAdminForSeller> find(AlarmSellerCategoryEnum category, AlarmSellerSubcategoryEnum subcategory) {
