...
public class PaymentTestDataInitializer {
    ...
    private Coupon createCoupon(String code, BenefitType benefitType, Long benefitValue, com.impacus.maketplace.common.enumType.coupon.ProductType productType, CoverageType useCoverageType, String brandName, StandardType useStandardType, Long useStandardValue) {
