...
public class DataLoader {
    ...
    public void loadData() {
        ...
        productRepository.save(new Product(1L, 1L, "아디다스 슈퍼스타", "1", DeliveryType.GENERAL_DELIVERY, 1L, 3000, 3000, 10000, 10000, 8000, 100, false, ProductStatus.SALES_PROGRESS, DiscountStatus.DISCOUNT_PROGRESS));
